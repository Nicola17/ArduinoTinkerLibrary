...
#else
	#define TNK_THROW(type,message){}
	#define TNK_THROW_LOGIC(message){}
	#define TNK_THROW_RUNTIME(message){}

	#define TNK_ASSERT(cond,type,message){}
	#define TNK_ASSERT_LOGIC(cond,message){}
	#define TNK_ASSERT_RUNTIME(cond,message){}
		
	#define TNK_THROW_RTN(type,message){}
	#define TNK_THROW_LOGIC_RTN(message){}
	#define TNK_THROW_RUNTIME_RTN(message){}
	#define TNK_THROW_RTNV(type,message,val){}
	#define TNK_THROW_LOGIC_RTNV(message,val){}
	#define TNK_THROW_RUNTIME_RTNV(message,val){}

	#define TNK_ASSERT_RTN(cond,type,message){}
	#define TNK_ASSERT_LOGIC_RTN(cond,message){}
	#define TNK_ASSERT_RUNTIME_RTN(cond,message){}
	#define TNK_ASSERT_RTNV(cond,type,message,val){}
	#define TNK_ASSERT_LOGIC_RTNV(cond,message,val){}
	#define TNK_ASSERT_RUNTIME_RTNV(cond,message,val){}

	#define STOP_SKETCH_ON_EXCEPTION(){}
	#define STOP_SKETCH_ON_EXCEPTION(val){}
#endif
#endif